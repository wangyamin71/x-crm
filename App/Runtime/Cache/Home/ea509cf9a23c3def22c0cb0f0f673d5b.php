...
<title>X-Mis系统登录 Power by 连云港信友科技有限公司 技术支持QQ 16129825</title>
<script src="/X-CRM3/Public/BJUI/js/jquery-1.7.2.min.js"></script>
<script src="/X-CRM3/Public/BJUI/js/jquery.cookie.js"></script>
<link href="/X-CRM3/Public/BJUI/themes/css/bootstrap.min.css" rel="stylesheet">
<style type="text/css">
* {font-family: "Verdana", "Tahoma", "Lucida Grande", "Microsoft YaHei", "Hiragino Sans GB", sans-serif;}
body {
    background: url(/X-CRM3/Public/images/loginbg/loginbg_01.jpg) no-repeat center center fixed;
...
function choose_bg() {
	...
	$('body').css('background-image', 'url(/X-CRM3/Public/images/loginbg/loginbg_0'+ bg +'.jpg)');
}
</script>
</head>
<body>
<div class="main_box">
	...
	<div class="login_box">
        <div class="login_logo">
            <img src="/X-CRM3/Public/images/logo.png" >
        </div>
        <!--
	...
	<div class="bottom">Power by  <a href="http://www.xinyou88.com/"target="_blank">连云港信友科技有限公司</a> 技术支持QQ:16129825 <div style="display:none"><script src="http://s96.cnzz.com/stat.php?id=1618465&web_id=1618465" language="JavaScript"></script></div></div>
</div>
</body>
</html>