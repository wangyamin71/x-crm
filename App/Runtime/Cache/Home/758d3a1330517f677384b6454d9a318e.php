<?php if (!defined('THINK_PATH')) exit();?><div class="bjui-pageContent tableContent">
    <form action="/X-CRM3/index.php?s=/Home/Ruku/add/navTabId/<?php echo CONTROLLER_NAME;?>" class="pageForm" data-toggle="validate">
		<input type="hidden" name="id" value="<?php echo ($id); ?>">
        <div class="pageFormContent" data-layout-h="0">
           <table class="table table-condensed table-hover" width="100%">
		  <tbody>
		   <Tr><td style="text-align:Center"><h3><?php echo (C("WEB_COMPANY_NAME")); ?>入库单</h3></td></tr>
		   <tr><td style="text-align:Center">单号：<input type='text'  name='bianhao' data-rule='required;' size='20'   value='<?php echo ($bianhao); ?>'  > &nbsp;&nbsp;&nbsp;&nbsp;来源:<input type='text'  name='type' data-rule='required;' size='20'   value='<?php echo ($Rs["type"]); ?>'  > &nbsp;&nbsp;&nbsp;&nbsp;入库时间:<input type='text' data-toggle='datepicker' name='shijian'  data-rule='required;' size='20' data-min-date="%y-%M-%d"  value='<?php echo (substr($Rs["shijian"],0,10)); ?>'  ></td></tr>
          </tbody>
		  </table>
		   <table class="table table-bordered table-hover table-striped table-top"   data-toggle="tabledit">
                <thead>
                    <tr>
                        ...
                        <th title="产品编号"><input type="text" name="index[#index#].name"  type="text"  value="" size="10" data-toggle="lookup" data-url='/X-CRM3/index.php?s=/Home/public/chuku/navTabId/<?php echo CONTROLLER_NAME;?>' data-group="index[#index#]" ></th>
