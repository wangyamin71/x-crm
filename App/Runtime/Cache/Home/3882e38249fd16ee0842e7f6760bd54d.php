...
<div class="bjui-pageContent tableContent">
    <form action="/X-CRM3/index.php?s=/Home/User/edit/navTabId/<?php echo CONTROLLER_NAME;?>" class="pageForm" data-toggle="validate">
          ...
          <table class="table table-condensed table-hover" width="100%">
           <tbody>
			<tr><td>
                ...
                <input type="text" data-rule="required" size="25" name="username" id="j_username" value="<?php echo ($Rs['username']); ?>" <?php if($id == 0): else: ?>readonly<?php endif; ?> >
             </td></tr>
            <tr><td>
