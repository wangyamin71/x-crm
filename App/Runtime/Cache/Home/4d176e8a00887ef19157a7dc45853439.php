<?php if (!defined('THINK_PATH')) exit();?><div class="bjui-pageContent tableContent">
    <form action="/X-CRM3/index.php?s=/Home/Chuku/edit/navTabId/<?php echo CONTROLLER_NAME;?>" class="pageForm" data-toggle="validate">
		<input type="hidden" name="id" value="<?php echo ($id); ?>">
        <div class="pageFormContent" data-layout-h="0">
           <table class="table table-condensed table-hover" width="100%">
		  <tbody>
		   <Tr><td style="text-align:Center"><h3><?php echo (C("WEB_COMPANY_NAME")); ?>出库单</h3></td></tr>
		   <tr><td style="text-align:Center">单号：<input type='text'  name='number' data-rule='required;' size='20'   value='<?php echo ($Rs["number"]); ?>'  > &nbsp;&nbsp;&nbsp;&nbsp;合同编号:<input type='text' id='bianhao' name='bianhao'  size='20' data-toggle='lookup' data-url='/X-CRM3/index.php?s=/Home/basic/hetong/navTabId/<?php echo CONTROLLER_NAME;?>'  value='<?php echo ($Rs["bianhao"]); ?>'  > &nbsp;&nbsp;&nbsp;&nbsp;出库时间:<input type='text' data-toggle='datepicker' name='shijian'  data-rule='required;' size='20' data-min-date="%y-%M-%d"  value='<?php echo (substr($Rs["shijian"],0,10)); ?>'  ></td></tr>
		   ...
		   <table class="table table-bordered table-hover table-striped table-top"   data-toggle="tabledit">
                ...
                <tbody>
                     <?php $list = M('chukus')->where(array("xid"=>$Rs['id']))->select(); ?>
