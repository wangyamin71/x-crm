    ...
    <div style="padding: 0 15px;">
        ...
        <div style="float:left; width:157px;">
            <div class="alert alert-info" role="alert" style="margin:0 0 5px; padding:10px;">
                <img src="/X-CRM3/Public/images/weixin.png" width="135">
            </div>
        </div>
        ...
        <div class="row" style="margin-left:170px; margin-top:10px;">
		 <form action="/X-CRM3/index.php?s=/Home/Index/index/navTabId/<?php echo CONTROLLER_NAME;?>" class="pageForm" data-toggle="validate">
